//
//  YMSegmentTitleView+Configuration.swift
//  SwiftDemo
//
...
extension HpSegmentTitleView {
    ...
    class Configuration: NSObject {
        ...
        func setupGradientColorRGB() {
            self.normalRGB[0] = self.titleNormalColor.cgColor.componentsMethode.red
            self.normalRGB[1] = self.titleNormalColor.cgColor.componentsMethode.green
            self.normalRGB[2] = self.titleNormalColor.cgColor.componentsMethode.blue
            self.normalRGB[3] = self.titleNormalColor.cgColor.componentsMethode.alpha
            
            self.selectRGB[0] = self.titleSelectedColor.cgColor.componentsMethode.red
            self.selectRGB[1] = self.titleSelectedColor.cgColor.componentsMethode.green
            self.selectRGB[2] = self.titleSelectedColor.cgColor.componentsMethode.blue
            self.selectRGB[3] = self.titleSelectedColor.cgColor.componentsMethode.alpha
        }
...
public extension CGColor {
    var componentsMethode: (red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat) {
        var r: CGFloat = 0
        var g: CGFloat = 0
        var b: CGFloat = 0
        var a: CGFloat = 0
