...
public class HpSegmentTitleCell: UICollectionViewCell {
    private var config: HpSegmentTitleView.Configuration!
...
extension HpSegmentTitleCell {
    func setCell(config: HpSegmentTitleView.Configuration, title: String, isMaxItem: Bool) {
        self.config = config
...
fileprivate extension HpSegmentTitleCell {
    func createSubviews() {
